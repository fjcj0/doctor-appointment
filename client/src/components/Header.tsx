...
import { arrowDownIcon, filterIcon, headerLinks, userLogo } from "../constants/data";
...
const Header = () => {
    ...
    const { openHeaderSlide } = useHeaderStore();
    useEffect(() => {
    ...
    return (
        ...
        >
            ...
            <div className="flex gap-2 items-center justify-center">
                ...
                <button type="button" className="md:hidden block" onClick={openHeaderSlide}>
